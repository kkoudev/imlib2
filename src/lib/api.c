...
{
   return imlib_load_image_with_scale_size(file, 0, 0);
}
...
{
   return imlib_load_image_immediately_with_scale_size(file, 0, 0);
}
...
{
   return imlib_load_image_without_cache_with_scale_size(file, 0, 0);
}
...
{
   return imlib_load_image_immediately_without_cache_with_scale_size(file, 0, 0);
}
...
{
   return imlib_load_image_with_error_return_and_scale_size(file, 0, 0, error_return);
}

/**
 * @param file Image file.
 * @param scale_width Image width for scale denom.
 * @param scale_height Image height for scale denom.
 * @return An image handle.
 *
 * Loads an image from disk located at the path specified by
 * @p file. Please see the section \ref loading for more
 ...
 */
EAPI                Imlib_Image
imlib_load_image_with_scale_size(const char *file, int scale_width, int scale_height)
{
   Imlib_Image         im = NULL;
   Imlib_Image         prev_ctxt_image;

   CHECK_CONTEXT(ctx);
   CHECK_PARAM_POINTER_RETURN("imlib_load_image_with_scale_size", "file", file, NULL);
   prev_ctxt_image = ctx->image;
   im = __imlib_LoadImageForScaleSize(file, (ImlibProgressFunction) ctx->progress_func,
                          ctx->progress_granularity, 0,
 ...
 */
EAPI                Imlib_Image
imlib_load_image_immediately_with_scale_size(const char *file, int scale_width, int scale_height)
{
   Imlib_Image         im = NULL;
   Imlib_Image         prev_ctxt_image;

   CHECK_CONTEXT(ctx);
   CHECK_PARAM_POINTER_RETURN("imlib_load_image_immediately_with_scale_size", "file", file,
                              NULL);
   prev_ctxt_image = ctx->image;
   im = __imlib_LoadImageForScaleSize(file, (ImlibProgressFunction) ctx->progress_func,
                          ctx->progress_granularity, 1,
                          scale_width, scale_height,
                          0, NULL);
   ctx->image = prev_ctxt_image;
   return (Imlib_Image) im;
 ...
 */
EAPI                Imlib_Image
imlib_load_image_without_cache_with_scale_size(const char *file, int scale_width, int scale_height)
{
   Imlib_Image         im = NULL;
   Imlib_Image         prev_ctxt_image;

   CHECK_CONTEXT(ctx);
   CHECK_PARAM_POINTER_RETURN("imlib_load_image_without_cache_with_scale_size", "file",
                              file, NULL);
   prev_ctxt_image = ctx->image;
   im = __imlib_LoadImageForScaleSize(file, (ImlibProgressFunction) ctx->progress_func,
                          ctx->progress_granularity, 0,
 ...
 */
EAPI                Imlib_Image
imlib_load_image_immediately_without_cache_with_scale_size(const char *file, int scale_width, int scale_height)
{
   Imlib_Image         im = NULL;
   Imlib_Image         prev_ctxt_image;

   CHECK_CONTEXT(ctx);
   CHECK_PARAM_POINTER_RETURN("imlib_load_image_immediately_without_cache_with_scale_size",
                              "file", file, NULL);
   prev_ctxt_image = ctx->image;
   im = __imlib_LoadImageForScaleSize(file, (ImlibProgressFunction) ctx->progress_func,
                          ctx->progress_granularity, 1,
 ...
 */
EAPI                Imlib_Image
imlib_load_image_with_error_return_and_scale_size(
                                   const char *file,
                                   ...
                                   Imlib_Load_Error * error_return)
{
   ...
   CHECK_CONTEXT(ctx);
   CHECK_PARAM_POINTER_RETURN("imlib_load_image_with_error_return_and_scale_size", "file",
                              file, NULL);
   ...
   prev_ctxt_image = ctx->image;
   im = (Imlib_Image) __imlib_LoadImageForScaleSize(file,
