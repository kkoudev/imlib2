...
# endif
   ...
   EAPI Imlib_Image imlib_load_image_with_error_return(const char *file,
                                                       Imlib_Load_Error *
                                                       error_return);
   EAPI Imlib_Image imlib_load_image_with_scale_size(const char *file, int scale_width, int scale_height);
   EAPI Imlib_Image imlib_load_image_immediately_with_scale_size(const char *file, int scale_width, int scale_height);
   EAPI Imlib_Image imlib_load_image_without_cache_with_scale_size(const char *file, int scale_width, int scale_height);
   EAPI Imlib_Image imlib_load_image_immediately_without_cache_with_scale_size(const char *file, int scale_width, int scale_height);
   EAPI Imlib_Image imlib_load_image_with_error_return_and_scale_size(const char *file,
